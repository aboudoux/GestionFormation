...
namespace GestionFormation.App.Views.Sessions
{
    public class ClotureWindowVm : PopupWindowVm
    {
        ...
        public ClotureWindowVm(Guid sessionId, IApplicationService applicationService, 
    ...
    {
        private readonly ClotureWindowVm _parent;
        private readonly DocumentManager _documentManager;
        private readonly IApplicationService _applicationService;
        private readonly Guid _seatId;        

        public StudentItem(ClotureWindowVm parent, ISeatValidatedResult seat, 
