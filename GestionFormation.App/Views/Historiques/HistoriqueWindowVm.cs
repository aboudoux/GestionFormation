...
namespace GestionFormation.App.Views.Historiques
{
    public class HistoriqueWindowVm : ViewModelBase, ILoadableVm
    {
        ...
        public HistoriqueWindowVm(IEventQueries eventQueries, IEventSerializer eventSerializer)
        {
