...
namespace GestionFormation.Tests
{
    ...
    public class LieuShould
    {
        ...
        {
            var lieu = Lieu.Create("Saint Priest", "allée du toscan", 1);
            lieu.UncommitedEvents.GetStream().Should().Contain(new LieuCreated(Guid.Empty, 0, "Saint Priest", "allée du toscan", 1));
        }
        ...
        public void raise_LieuUpdated_on_update_lieu()
        {
            ...
            history.Add(new LieuCreated(Guid.Empty, 1, "Saint Priest", "yolo",1));

            var lieu = new Lieu(history);
            lieu.Update("Saint Priest", "tata",2);
            lieu.UncommitedEvents.GetStream().Should().Contain(new LieuUpdated(Guid.Empty, 0, "Saint Priest", "tata",2));
        }
        ...
        public void raise_LieuDeleted_on_delete_lieu()
        {
            ...
            var lieu = new Lieu(history);
            lieu.Delete();
            lieu.UncommitedEvents.GetStream().Should().Contain(new LieuDeleted(Guid.Empty, 0));
        }
        ...
        public void dont_raise_LieuDeleted_if_lieu_already_deleted()
        {
            var history = new History();
            history.Add(new LieuCreated(Guid.Empty, 1, "Saint Priest", "yolo",1));
            history.Add(new LieuDeleted(Guid.Empty, 2));
        ...
        public void dont_raise_multiple_update_if_last_update_is_same_data()
        {
            var history = new History();
            history.Add(new LieuCreated(Guid.Empty, 1, "Saint Priest", "yolo",1));
            history.Add(new LieuUpdated(Guid.Empty, 2, "Saint Priest", "test",1));
        ...
        {
            var queries = new FakeLieuQueries();
        ...
        public void throw_error_if_updating_name_whith_same_name()
        {
            ...
            eventStore.Save(new LieuCreated(lieuId,1, "COUCOU", "osef",1));
        ...
        public void dont_throw_error_if_updating_myself()
        {
            ...
            eventStore.GetEvents(lieuId).Should().Contain(new LieuUpdated(lieuId, 0, "COUCOU", "ok", 2));            
        }

        [TestMethod]
        public void throw_error_if_create_with_empty_name()
        {
            Action action = () => Lieu.Create("", "",1);
        ...
        {
            var history = new History();
            history.Add(new LieuCreated(Guid.NewGuid(), 1, "Lyon", "test", 5));
            var lieu = new Lieu(history);

            lieu.Assign(new DateTime(2017, 12, 20), 3);
            lieu.UncommitedEvents.GetStream().Should().Contain(new LieuAssigned(Guid.Empty, 0, new DateTime(2017, 12, 20), 3));
        }
        ...
        public void throw_error_if_lieu_already_assigned_to_a_session(string startDate, int durée)
        {
            var history = new History();
            history.Add(new LieuCreated(Guid.NewGuid(), 1, "Lyon", "test", 5));
            history.Add(new LieuAssigned(Guid.NewGuid(), 2 , new DateTime(2017, 01, 15), 10));
            var lieu = new Lieu(history);
        ...
        public void raise_lieuReasigned_when_change_lieu_assignation()
        {
            ...
            lieu.UncommitedEvents.GetStream().Should().Contain(new LieuReassigned(Guid.Empty, 0, new DateTime(2017, 01, 15), 10, new DateTime(2017, 01, 10), 10));
        }
        ...
        public void throw_error_if_trying_to_reassign_lieu_to_an_already_assigned_session()
        {
            ...
            history.Add(new LieuCreated(Guid.NewGuid(), 1, "Lyon", "test", 5));
            history.Add(new LieuAssigned(Guid.NewGuid(), 2, new DateTime(2017, 01, 15), 10));
            history.Add(new LieuAssigned(Guid.NewGuid(), 3, new DateTime(2017, 02, 15), 10));
            var lieu = new Lieu(history);
        ...
        public void raise_lieuUnassigned_if_lieu_no_longer_assigned_to_a_session()
        {
            ...
            lieu.UncommitedEvents.GetStream().Should().Contain(new LieuUnassigned(Guid.Empty, 0, new DateTime(2017, 02, 15), 10));
        }
        ...
        {
            var history = new History();
            history.Add(new LieuCreated(Guid.NewGuid(), 1, "Paris", "test", 5));
            var lieu = new Lieu(history);
        ...
        public void reasign_old_period_if_properly_removed_from_event_store()
        {
            ...
            history.Add(new LieuCreated(Guid.NewGuid(), 1, "Paris", "test", 5));
            history.Add(new LieuAssigned(Guid.NewGuid(), 2, new DateTime(2017, 01, 15), 10));
            history.Add(new LieuUnassigned(Guid.NewGuid(), 2, new DateTime(2017, 01, 15), 10));

            var lieu = new Lieu(history);
            lieu.Assign(new DateTime(2017, 01, 13), 10);

            lieu.UncommitedEvents.GetStream().Should().Contain(new LieuAssigned(Guid.Empty, 1, new DateTime(2017, 01, 13), 10));
        }
        ...
        public void throw_error_if_trying_to_delete_assigned_lieu()
        {
            ...
            action.ShouldThrow<ForbiddenDeleteLieuException>();
        }
